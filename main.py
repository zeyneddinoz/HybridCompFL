...
PARTICIPATION_RATE = 0.6            # (30% of randomly selected devices share their LM with the server per global round.)
PERCENTAGE_OF_CAPABLE_DEVICES = 0.3 # (Only 20% of devices can train GM.)
LOCAL_EPOCH = 5                     # 3, 5
