...
# In[2] ###################################### SETTINGS ######################################
# === User inputs ===
MODEL_NAME = 'AlexNet'                # LeNet | AlexNet | VGG16
DATASET_NAME = 'FashionMNIST'              # MNIST | FashionMNIST | CIFAR10
...
PERCENTAGE_OF_CAPABLE_DEVICES = 0.1 # For 0.2, only 20% of devices can train GM.
LOCAL_EPOCH = 5                     # 3, 5
...
print(f"Overall Participation Rate: {fl_setup['num_participating_devices']/fl_setup['total_devices']*100:.1f}% ({fl_setup['num_participating_devices']} of {fl_setup['total_devices']} devices)")
...
print("""
############################### EVALUATION RESULTS OF TRAINED GLOBAL MODEL ###############################
=== Model Performance ===
Loss:         {:.4f}
Accuracy (%): {:.2f}%
Precision (%):{:.2f}%
